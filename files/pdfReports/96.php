...
Where
    ...
    AND (','||Giver.Tags||',') not like '%,hel&aring;r,%'
    AND (','||Giver.Tags||',') not like '%,halv&aring;r,%'
    AND Land = 'S'
...
//params here
    ...
    $page->setFont($font, 1);
    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'624','xStart'=>'100','xEnd'=>'215','align'=>'right'),utf8_decode("$account"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'624','xStart'=>'270','xEnd'=>'290','align'=>'right'),utf8_decode("$givTot"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'624','xStart'=>'299','xEnd'=>'','align'=>'left'),utf8_decode("00"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'624','xStart'=>'334','xEnd'=>'','align'=>'left'),utf8_decode("$checkSum"),$page,$offsety);    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    $page->setFont($font, 10);
    ...
    $page->setFont($font, 1);
    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'344','xStart'=>'100','xEnd'=>'215','align'=>'right'),utf8_decode("$account"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'344','xStart'=>'270','xEnd'=>'290','align'=>'right'),utf8_decode("$givTot"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'344','xStart'=>'299','xEnd'=>'','align'=>'left'),utf8_decode("00"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'344','xStart'=>'334','xEnd'=>'','align'=>'left'),utf8_decode("$checkSum"),$page,$offsety);    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    $page->setFont($font, 10);
    ...
    $page->setFont($font, 1);
    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'63','xStart'=>'100','xEnd'=>'215','align'=>'right'),utf8_decode("$account"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'63','xStart'=>'270','xEnd'=>'290','align'=>'right'),utf8_decode("$givTot"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'63','xStart'=>'299','xEnd'=>'','align'=>'left'),utf8_decode("00"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'63','xStart'=>'334','xEnd'=>'','align'=>'left'),utf8_decode("$checkSum"),$page,$offsety);    }
    //end of giver loop.
}
...
//output pdf inline
$dfile = "Inbetalningskort (alla)$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Inbetalningskort (alla).pdf";
}
