...
<tr><th colspan="2">Projekt 51</th></tr>
<tr><td colspan="2">Skriver ut lista på pengar som gått till projekt 51. Endast givare som har mer än 0kr visas i listan.</td></tr>
<tr><td colspan="2">
...
Where
      Payment.ProjectId IN(1,2,6,8,9,10,13,28,31,34,36,39,40,42,44,45)
      AND Payment.InKrTotal > 199
      AND Giver.Land = 'S'
Group by Payment.GiverId
HAVING SUM(Payment.InKrTotal) > 1999
Order by Payment.GiverId";
    ...
    $pdf->ezTable(
	    ...
	    ,array('Payment.GiverId'=>'Givar#'  
                ...
                ,'Giver.PersonNbr'=>'Egen anteckning'  
