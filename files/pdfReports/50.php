...
<tr><th colspan="2">Barnrapport - kollektiv</th></tr>
<tr><td colspan="2">Skriver ut brev som skickas med kollektiv rapport från faddebarn.<br /><br/><b><i>OBS när du klickar på 'Kör' läggs datum för rapport till barnet.</B></I></td></tr><tr><td>Barn#:</td><td><input name="id" value="<?
...
$db->Insert(array(
    'table'=>'action',
    'fields'=>array(
        'actionName'=>'Utskrift Barnrapport - kollektiv'
        ,'entityName'=>'Fadderbarn'
        ,'entityId'=>$row['Fadderbarn.Id']
        ,'date'=>date('Y-m-d', time())
        ,'notes'=>'Utskrift Barnrapport - kollektiv'
    )
    ...
    alignedText(array('y'=>'475','xStart'=>'56','xEnd'=>'92','align'=>'left'),utf8_decode("Område:"),$page,$offsety);    $t = array('y'=>475,'align'=>'left','xStart'=>107,'xEnd'=>'530');
...
//output pdf inline
$dfile = "Barnrapport - kollektiv$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Barnrapport - kollektiv.pdf";
}
