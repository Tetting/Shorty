...
<tr><th colspan="2">Adressetiketter (Kommissionärer)</th></tr>
<tr><td colspan="2">Skriver ut adressetiketter för alla kommissionärer.</td></tr>
<tr><td colspan="2">
...
<?
    ...
    $db = easyDB('');
    $pdf->ezText("<b>Kommission&auml;rer
2st tidningar</b>");
    $pdf->ezSetDy(-76);
    $query="Select
    *
