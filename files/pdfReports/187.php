...
<tr><th colspan="2">Husvagn - betalning</th></tr>
<tr><td colspan="2">Skriver ut lista med med info hur mycket hyresgästen betalat.</td></tr>
<tr><td colspan="2">
...
<?
    ...
    $query="Select
     Caravan.*
    ,Payment.ProjectId
    ,SUM(Payment.InKrTotal) as tot301
From
    Caravan JOIN Payment ON Caravan.GivNr = Payment.GiverId
Where
    Payment.ProjectId = '301'
    AND strftime('%Y',Payment.Date) = '2014'
...
Order by Caravan.Nr";
    ...
    $pdf->ezTable(
	    ...
	    ,array('Caravan.Nr'=>'#'  
                ,'Caravan.GivNr'=>'Givar#'  
                ,'Caravan.HiredBy'=>'Hyresg&auml;st'  
                ,'Caravan.Location'=>'Placering'  
                ,'Caravan.TotalPrice'=>'Pris'  
                ,'tot301'=>'Inbetalt'  
                
        )
	    ,html_entity_decode("Husvagnslista - betalning")
        //options
