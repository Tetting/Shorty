...
<tr><td colspan="2">Skriver ut brev till givare som ger månatligt till angivet projekt.</td></tr><tr><td>Projekt#:</td><td><input name="id" value="<?
...
//output pdf inline
$dfile = "Månatliga givare - rapport$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Månatliga givare - rapport.pdf";
}
