...
<tr><th colspan="2">Inbetalningskort (Helår)</th></tr>
<tr><td colspan="2">Skriver inbetalningskort till alla givare <br />som är taggade med "helår".</td></tr>
<tr><td colspan="2">
...
";
    ...
    alignedText(array('y'=>'240','xStart'=>'56','xEnd'=>'300','align'=>'left'),utf8_decode("Inbetalning för helår"),$page,$offsety);    $page->setFont($page->getFont(), 10);
...
//output pdf inline
$dfile = "Inbetalningskort (Helår)$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Inbetalningskort (Helår).pdf";
}
