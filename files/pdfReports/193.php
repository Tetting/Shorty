...
<tr><td colspan="2">Lista på barn som inte skickat rapport de senaste året.<br />OBS endast barn som haft fadder i ett år.</td></tr><tr><td>Område#:</td><td><input name="area" value="<?
...
From 
    Fadderbarn
Where 
    Fadderbarn.Area1 = '".$_REQUEST['area']."'
	...
	Order by Fadderbarn.RepThis ASC";
    ...
    $pdf->ezText("<b>Late report list - $area $areaName</b>",14);
...
Where 
    ...
    $pdf->ezTable(
	    ...
	    ,array('NewPageCallback' => 'NewPageCallback'
            ...
            ,'shaded'=>0
            ,'showLines'=>0
		,'showHeadings' => '1'		,'showLines' => '0'		,'fontSize' => '9')
    );
