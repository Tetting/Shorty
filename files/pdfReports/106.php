...
<tr><th colspan="2">Husvagn - info egna</th></tr>
<tr><td colspan="2">Skriver ut placeringskort för egna husvagnar på Ralle.</td></tr>
<tr><td colspan="2">
...
while($row) {    $page->rotate(0, 0, deg2rad(90));    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    ...
    $t = array('y'=>-152,'align'=>'left','xStart'=>97,'xEnd'=>'400');
...
//output pdf 
$dfile = "Husvagn - info egna$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Husvagn - info egna.pdf";
}
