...
<tr><th colspan="2">Barnavslut - ej nytt</th></tr>
<tr><td colspan="2">Detta brev skickas när ett barn lämnar vårt<br />system och givaren inte ska ha ett nytt.<br /><br />Fyll i barn# och orsak varför barnet avslutas.</td></tr><tr><td>Barn#:</td><td><input name="id" value="<?
...
?>"/></td></tr>
<tr><td>Text:</td><td><textarea rows="3" cols="16" name="text"><?
...
while($row) {    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    ...
    $t = array('y'=>553,'align'=>'left','xStart'=>234,'xEnd'=>'530');
