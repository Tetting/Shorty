...
<tr><th colspan="2">Skattreduktion - projektlista</th></tr>
<tr><td colspan="2">Lista på projekt godkända för skattereduktion.</td></tr>
<tr><td colspan="2">
...
Order by Id";
    ...
    $pdf->ezTable(
	    ...
	    ,html_entity_decode("<b>Projekt godk&auml;nda f&ouml;r skattereduktion</b>")
        //options
