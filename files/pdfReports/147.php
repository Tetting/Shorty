...
<tr><th colspan="2">Inbetalt per år</th></tr>
<tr><td colspan="2">Skriver ut lista på inbetalt per år för angiven givare.</td></tr><tr><td>Givare#:</td><td><input name="id" value="<?
...
Where
    ...
    //add a totals row...
    $row = array();
    $row["SUM(Payment.InKrTotal)"] = "<b>".$tot."</b>";$row["Payment.ProjectId"] = "Summa";
    $data[] = $row;
    ...
    $pdf->ezTable(
	    ...
	    ,array('Payment.ProjectId'=>'Projekt#'  
                ...
                ,'SUM(Payment.InKrTotal)'=>'Kr'  
                
        )
	    ,html_entity_decode("<b>Inbetalt $year Givare $id</b>")
        //options
