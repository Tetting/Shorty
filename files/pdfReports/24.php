...
<tr><th colspan="2">Barnrapport - endast foto</th></tr>
<tr><td colspan="2">Skriver ut brev som skickas med foto från faddebarn.<br /><br/><b><i>OBS när du klickar på 'Kör' läggs datum för rapport till barnet.</B></I></td></tr><tr><td>Barn#:</td><td><input name="id" value="<?
...
//output pdf inline
$dfile = "Barnrapport - endast foto$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Barnrapport - endast foto.pdf";
}
