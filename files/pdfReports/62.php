...
<tr><td colspan="2">Skriv ett fritt brev.<br />Givarens adress läggs till automatiskt.</td></tr><tr><td>Givare#:</td><td><input name="id" value="<?
...
while($row) {
    ...
    $t = array('y'=>577,'align'=>'left','xStart'=>90,'xEnd'=>'200');
    alignedText($t,dbTexts('Name',$row,' '),$page,$offsety);
    $page->setFont($page->getFont(), 12);
    alignedText(array('y'=>'550','xStart'=>'56','xEnd'=>'485','align'=>'wrap'),utf8_decode("$letter"),$page,$offsety);    $page->setFont($page->getFont(), 10);
...
//output pdf 
$dfile = "Fritt brev (TG)$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Fritt brev (TG).pdf";
}
