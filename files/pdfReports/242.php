...
while($row) {    $page->rotate(0, 0, deg2rad(90));    $t = array('y'=>-250,'align'=>'left','xStart'=>390,'xEnd'=>'550');
    ...
    $t = array('y'=>-14,'align'=>'center','xStart'=>20,'xEnd'=>'360');
...
//output pdf 
$dfile = "Inbjudningskort ny_clone$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Inbjudningskort ny_clone.pdf";
}
