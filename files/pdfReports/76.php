...
<tr><td colspan="2">Detta brev skickas till givare som skrivit på löftesofferkort.
<br/>
OBS! När du trycker på kör läggs ett till engångslöfte till under givaren.</td></tr><tr><td>Givare#:</td><td><input name="id" value="<?
...
$db->Insert(array(
    ...
    alignedText(array('y'=>'553','xStart'=>'387','xEnd'=>'530','align'=>'left'),utf8_decode("$projectName"),$page,$offsety);    $t = array('y'=>236,'align'=>'left','xStart'=>141,'xEnd'=>'530');
...
//output pdf inline
$dfile = "Löftesoffer$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Löftesoffer.pdf";
}
