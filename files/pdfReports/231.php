...
<tr><td colspan="2">Skriver ut kontrolluppgifter för skattereduktion till givare.</td></tr><tr><td>Giver#:</td><td><input name="id" value="<?
...
//output pdf inline
$dfile = "Skattereduktion - kontrolluppgifter (givare)$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Skattereduktion - kontrolluppgifter (givare).pdf";
}
