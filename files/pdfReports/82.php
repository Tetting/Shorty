...
<tr><th colspan="2">Custom med adress</th></tr>
<tr><td colspan="2">Skriver ut custom brev.</td></tr><tr><td>Givare#:</td><td><input name="id" value="<?
...
while($row) {
    ...
    alignedText($t,dbTexts('Id,Giver.FullName,Giver.CoAddress,Giver.Address,Giver.Post',$row,'EOL'),$page,$offsety);
    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'581','xStart'=>'56','xEnd'=>'100','align'=>'left'),utf8_decode("Bäste"),$page,$offsety);    $t = array('y'=>581,'align'=>'left','xStart'=>85,'xEnd'=>'530');
...
//output pdf inline
$dfile = "Custom med adress$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Custom med adress.pdf";
}
