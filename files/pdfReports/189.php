...
while($row) {
    ...
    alignedText(array('y'=>'575','xStart'=>'56','xEnd'=>'200','align'=>'left'),utf8_decode("Bäste"),$page,$offsety);    $t = array('y'=>575,'align'=>'left','xStart'=>90,'xEnd'=>'200');
...
//output pdf 
$dfile = "Fritt brev (Betel)$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Fritt brev (Betel).pdf";
}
