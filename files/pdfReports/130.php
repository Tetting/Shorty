...
<tr><th colspan="2">Barnbyte - ej rapport</th></tr>
<tr><td colspan="2">Detta brev skickas när ett barn tas bort<br />från vårt
system p g a utebliven rapport.</td></tr><tr><td>Barn#:</td><td><input name="id" value="<?
...
while($row) {    $t = array('y'=>735,'align'=>'left','xStart'=>340,'xEnd'=>'530');
    ...
    $t = array('y'=>533,'align'=>'left','xStart'=>56,'xEnd'=>'530');
...
//output pdf inline
$dfile = "Extra gåva (Poltava)$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Extra gåva (Poltava).pdf";
}
