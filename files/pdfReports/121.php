...
<tr><th colspan="2">Adressetiketter (Praise)</th></tr>
<tr><td colspan="2">Skriver ut adressetiketter för alla<br /> församlingar som har taggen 'Praise'.</td></tr>
<tr><td colspan="2">
...
Order by Zip ASC";
    ...
    foreach($data as $row) {
        $r++;
        $text = "<b>".$row['ChurchName']."</b>" . PHP_EOL;
        if ($row['coAddress']) {
        ...
        $text .= $row['Zip'].'  '.$row['ZipTown'] . PHP_EOL;
