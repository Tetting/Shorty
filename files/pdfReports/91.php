...
<tr><th colspan="2">Husvagn - faktura hyresgäst</th></tr>
...
while($row) {    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    ...
    $t = array('y'=>703,'align'=>'left','xStart'=>92,'xEnd'=>'530');
    ...
    $page->setFont($font, 12);
    $t = array('y'=>661,'align'=>'right','xStart'=>400,'xEnd'=>'477');
    alignedText($t,dbTexts('Caravan.Nr',$row,' '),$page,$offsety);
    $t = array('y'=>648,'align'=>'left','xStart'=>94,'xEnd'=>'530');
    alignedText($t,dbTexts('Caravan.OwnerName,Caravan.Tel',$row,' '),$page,$offsety);
    $t = array('y'=>633,'align'=>'wrap','xStart'=>124,'xEnd'=>'480');
    alignedText($t,dbTexts('Caravan.Info',$row,' '),$page,$offsety);
    $t = array('y'=>606,'align'=>'right','xStart'=>80,'xEnd'=>'114');
    alignedText($t,dbTexts('Caravan.Price',$row,' '),$page,$offsety);
    $t = array('y'=>592,'align'=>'right','xStart'=>100,'xEnd'=>'143');
    alignedText($t,dbTexts('Caravan.TotalPrice',$row,' '),$page,$offsety);
    $t = array('y'=>261,'align'=>'left','xStart'=>141,'xEnd'=>'480');
    alignedText($t,dbTexts('Giver.Id',$row,' '),$page,$offsety);
    $t = array('y'=>234,'align'=>'left','xStart'=>122,'xEnd'=>'480');
    alignedText($t,dbTexts('Caravan.Nr',$row,' '),$page,$offsety);
    $t = array('y'=>220,'align'=>'left','xStart'=>90,'xEnd'=>'480');
    alignedText($t,dbTexts('Caravan.TotalPrice',$row,' '),$page,$offsety);
    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arialbd.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    $page->setFont($font, 12);
...
//output pdf inline
$dfile = "Husvagn - faktura hyresgäst$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Husvagn - faktura hyresgäst.pdf";
}
