...
<tr><th colspan="2">Husvagn - placering</th></tr>
<tr><td colspan="2">Husvagnslista att användas vi placeringsplanering.</td></tr>
<tr><td colspan="2">
...
Where 
    (Caravan.Status is null or Caravan.Status != 'Inaktiv')
Order by Caravan.Nr";
    ...
    $pdf->ezTable(
        ...
        //columns
	    ,array('Caravan.Nr'=>'#'  
                ,'Giver.FullName'=>'Hyresg&auml;st'  
                ,'Caravan.Location'=>'Placering'  
                ,'Caravan.Equipment'=>'Information'  
                
        )
	    ,html_entity_decode("Husvagnslista - hyrda")
        //options
