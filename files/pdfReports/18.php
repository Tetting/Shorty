...
while($row) {
    ...
    alignedText(array('y'=>'-52','xStart'=>'50','xEnd'=>'370','align'=>'center'),utf8_decode("Barnnr ${row['Nbr']}"),$page,$offsety);    $t = array('y'=>-65,'align'=>'center','xStart'=>50,'xEnd'=>'370');
    alignedText($t,dbTexts('Area1,Area',$row,' '),$page,$offsety);
    $t = array('y'=>-80,'align'=>'center','xStart'=>50,'xEnd'=>'370');
    alignedText($t,dbTexts('CountryName',$row,' '),$page,$offsety);
    ...
    alignedText($t,dbTexts('Nbr',$row,' '),$page,$offsety);
...
//output pdf inline
$dfile = "Barn - fotoram$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Barn - fotoram.pdf";
}
