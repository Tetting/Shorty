...
<tr><th colspan="2">Barnavslut</th></tr>
<tr><td colspan="2">Detta brev skickas när ett barn avslutas.<br /> Fyll i önskad text.</td></tr><tr><td>Barn#:</td><td><input name="id" value="<?
...
if(isset($_REQUEST['text'])) {
    ...
    print 'Önskar du underhålla ett nytt barn är du välkommen att höra av dig till oss eller besöka vår hemsida www.trosgnistan.se
...
while($row) {    $t = array('y'=>735,'align'=>'left','xStart'=>340,'xEnd'=>'530');
    ...
    $t = array('y'=>551,'align'=>'left','xStart'=>233,'xEnd'=>'530');
...
//output pdf inline
$dfile = "Barnavslut$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Barnavslut.pdf";
}
