...
<tr><td colspan="2">Skriver ut lista på givare som är berättigade för skattereduktion.</td></tr><tr><td>År:</td><td><input name="year" value="<?
...
Order by GiverID Asc";
    ...
    $pdf->ezTable(
	    ...
	    ,array('Giver.Id'=>'Givar#'  
                ,'SUM(eligable.giftsOver200)'=>'Summa'  
                ,'Giver.PersonNbr'=>'Personnummer'  
                ,'Giver.FullName'=>'Namn'  
                
        )
	    ,html_entity_decode("Skattereduktion $year")
        //options
