...
while($row) {    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    ...
    alignedText(array('y'=>'695','xStart'=>'400','xEnd'=>'545','align'=>'right'),utf8_decode("Bollnäs 2014-12-10"),$page,$offsety);    $t = array('y'=>679,'align'=>'left','xStart'=>76,'xEnd'=>'530');
    alignedText($t,dbTexts('Name',$row,' '),$page,$offsety);
    $t = array('y'=>224,'align'=>'left','xStart'=>80,'xEnd'=>'530');
...
//output pdf inline
$dfile = "Prenumeration Trons Gnista$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Prenumeration Trons Gnista.pdf";
}
