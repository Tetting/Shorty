...
";
    ...
    $t = array('y'=>581,'align'=>'left','xStart'=>96,'xEnd'=>'540');
    alignedText($t,dbTexts('Giver.Name',$row,' '),$page,$offsety);
    $t = array('y'=>528,'align'=>'left','xStart'=>52,'xEnd'=>'540');
    alignedText($t,dbTexts('Fadderbarn.Id,Fadderbarn.Name',$row,'EOL'),$page,$offsety);
    $t = array('y'=>528,'align'=>'left','xStart'=>52,'xEnd'=>'540');
    alignedText($t,dbTexts('',$row,' '),$page,$offsety);
    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>596,'xStart'=>440,'xEnd'=>540,'align'=>''),"".date('Y-m-d')."",$page,$offsety);
