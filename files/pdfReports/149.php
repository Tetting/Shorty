...
<tr><th colspan="2">Betelmedlem inb/år</th></tr>
<tr><td colspan="2">Skriver ut lista på hur mycket Betels medlemmar har gett under ett år.</td></tr><tr><td>År:</td><td><input name="id" value="<?
...
Where
    ...
    AND ProjectId != '303'
    AND ProjectId != '304'
    AND strftime('%Y',Payment.Date) = $id
    AND Giver.Land = 'S'
Group by Giver.Id
Order by Giver.LastName";
    ...
    $pdf->ezTable(
	    ...
	    ,html_entity_decode("<b>G&aring;vor till TG fr&aring;n Betelmedlemmar &aring;r $id</b>")
        //options
