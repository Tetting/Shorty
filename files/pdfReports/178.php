...
<tr><th colspan="2">Betel (f d medlemmar)</th></tr>
<tr><td colspan="2">Skriver ut Betels matrikel.</td></tr>
<tr><td colspan="2">
...
<?
    ...
    ,coAddress || ' '|| Address || ',  ' || Zip || '  ' || ZipTown as 'Post'
From
    Betel
Where
    Status='Inaktiv'
Order by LastName";
    ...
    $pdf->ezTable(
	    ...
	    ,html_entity_decode("<b>f.d. medlemmar</b>")
        //options
    ...
    $pdf->doHeader("<b>Betel</b>",10,'right');
...
$pdf->siHeadersAndFooters(array('AllPages'=>'pageNoFooter'));    $pdf->doFooter("<b>Betel</b>",10,'right');
