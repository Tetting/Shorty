...
//params here
    ...
    $page->setFont($font, 10);
    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'627','xStart'=>'100','xEnd'=>'217','align'=>'right'),utf8_decode("$account"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'627','xStart'=>'270','xEnd'=>'302','align'=>'right'),utf8_decode("$givTot"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'627','xStart'=>'334','xEnd'=>'','align'=>'left'),utf8_decode("$checkSum"),$page,$offsety);    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    $page->setFont($font, 10);
    ...
    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'346','xStart'=>'100','xEnd'=>'217','align'=>'right'),utf8_decode("$account"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'346','xStart'=>'270','xEnd'=>'302','align'=>'left'),utf8_decode("$givTot"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'346','xStart'=>'334','xEnd'=>'','align'=>'left'),utf8_decode("$checkSum"),$page,$offsety);    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    $page->setFont($font, 10);
    ...
    $page->setFont($font, 12);
    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'66','xStart'=>'100','xEnd'=>'217','align'=>'right'),utf8_decode("$account"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'66','xStart'=>'270','xEnd'=>'302','align'=>'left'),utf8_decode("$givTot"),$page,$offsety);    $page->setFont($page->getFont(), 10);
    alignedText(array('y'=>'66','xStart'=>'334','xEnd'=>'','align'=>'left'),utf8_decode("$checkSum"),$page,$offsety);
