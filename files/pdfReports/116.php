...
<tr><th colspan="2">Mat för Dagen - mån</th></tr>
<tr><td colspan="2">Detta brev skickas till givare som börjar ge månatligen till Mat för Dagen.</td></tr><tr><td>Givare#:</td><td><input name="id" value="<?
...
//output pdf inline
$dfile = "Mat för Dagen - mån$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Mat för Dagen - mån.pdf";
}
