...
<tr><th colspan="2">Löftesoffer - mån</th></tr>
...
while($row) {    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    ...
    alignedText(array('y'=>'553','xStart'=>'56','xEnd'=>'490','align'=>'wrap'),utf8_decode("Vi tackar för ditt löfte att månatligen stödja följande missionsprojekt: $projectName med $sum kr/mån. Vi bifogar inbetalningskort ni kan använda."),$page,$offsety);    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
...
//output pdf inline
$dfile = "Löftesoffer - mån$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Löftesoffer - mån.pdf";
}
