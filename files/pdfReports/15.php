...
<tr><td colspan="2">Detta brev skickas när ett barn lämnar vårt<br />
system och givaren ska ha ett nytt.<br /><br />
Fyll i barn# och orsak varför barnet avslutas.</td></tr><tr><td>Barn#:</td><td><input name="id" value="<?
...
?>"/></td></tr>
<tr><td>Orsak till avslut:</td><td><textarea rows="3" cols="20" name="text"><?
...
while($row) {    $t = array('y'=>735,'align'=>'left','xStart'=>340,'xEnd'=>'530');
    ...
    $t = array('y'=>553,'align'=>'left','xStart'=>290,'xEnd'=>'530');
