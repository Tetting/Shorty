...
<tr><th colspan="2">Medlemsbekräftelse</th></tr>
<tr><td colspan="2">Detta brev skickas till givare som önskar medlemsskap.</td></tr><tr><td>Givare#:</td><td><input name="id" value="<?
...
while($row) {    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    ...
    alignedText($t,dbTexts('Id,FullName,CoAddrss,Address,Post',$row,'EOL'),$page,$offsety);
    $t = array('y'=>593,'align'=>'left','xStart'=>92,'xEnd'=>'530');
    alignedText($t,dbTexts('Name',$row,' '),$page,$offsety);
    $t = array('y'=>197,'align'=>'left','xStart'=>128,'xEnd'=>'530');
    ...
    alignedText(array('y'=>'217','xStart'=>'330','xEnd'=>'530','align'=>'left'),utf8_decode("Trosgnistans Mission"),$page,$offsety);    $t = array('y'=>180,'align'=>'','xStart'=>330,'xEnd'=>'530');
    alignedText($t,dbTexts('Id,FullName,CoAddrss,Address,Post',$row,'EOL'),$page,$offsety);
...
//output pdf inline
$dfile = "Medlemsbekräftelse$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Medlemsbekräftelse.pdf";
}
