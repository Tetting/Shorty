...
<tr><th colspan="2">Ny Evangelistfadder</th></tr>
<tr><td colspan="2">Skriver ut brev till nya evangelistfaddrar.</td></tr><tr><td>Givare#:</td><td><input name="id" value="<?
...
//output pdf inline
$dfile = "Ny Evangelistfadder$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Ny Evangelistfadder.pdf";
}
