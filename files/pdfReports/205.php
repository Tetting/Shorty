...
<tr><th colspan="2">Projekrapport</th></tr>
...
<?
  ...
  $id = $_REQUEST['id'];
    ...
    ,ROUND(SUM(InKr),2) as insum
    ,ROUND(SUM(AdminCharge),2) as admsum
    ,ROUND(SUM(InKrTotal),2) as totsum
FROM
    Payment
Where
    ProjectId = '$id'
    And Date > month('now','-12 month')
...
Order By strftime('%Y-%m', Date)";
    ...
    $pdf->ezTable(
	    ...
	    ,html_entity_decode("<b>Inbetalt senaste &aring;ret</b>")
        //options
