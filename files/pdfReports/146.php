...
<tr><th colspan="2">Lista (taggar)</th></tr>
<tr><td colspan="2">Lista på givare med angiven tagg.</td></tr><tr><td>Tagg:</td><td><input name="id" value="<?
...
Group by GivProj.ProjectId
Order by GivProj.ProjectId";
    ...
    $pdf->ezTable(
        $data
        //columns
	    ,array('Project.Id'=>'<b>Nr</b>'  
                ,'Project.Project'=>'<b>Projekt</b>'  
                ,'totproj'=>'<b>Kr/M&aring;n</b>'  
