...
//params here
    ...
    alignedText(array('y'=>'805','xStart'=>'45','xEnd'=>'600','align'=>'left'),utf8_decode("$giverText"),$page,$offsety);    $t = array('y'=>740,'align'=>'left','xStart'=>300,'xEnd'=>'');
    ...
    alignedText(array('y'=>'627','xStart'=>'100','xEnd'=>'215','align'=>'right'),utf8_decode("$account"),$page,$offsety);    $page->setFont($page->getFont(), 12);
    alignedText(array('y'=>'627','xStart'=>'270','xEnd'=>'290','align'=>'right'),utf8_decode("$givTot"),$page,$offsety);    $page->setFont($page->getFont(), 12);
    alignedText(array('y'=>'627','xStart'=>'298','xEnd'=>'','align'=>'left'),utf8_decode("00"),$page,$offsety);    $page->setFont($page->getFont(), 12);
    alignedText(array('y'=>'627','xStart'=>'330','xEnd'=>'','align'=>'left'),utf8_decode("$checkSum"),$page,$offsety);    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    $page->setFont($font, 10);
    ...
    alignedText(array('y'=>'525','xStart'=>'45','xEnd'=>'600','align'=>'left'),utf8_decode("$giverText"),$page,$offsety);    $t = array('y'=>459,'align'=>'left','xStart'=>300,'xEnd'=>'');
    alignedText($t,dbTexts('FullName,CoAddress,Address,Post',$row,'EOL'),$page,$offsety);
    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/OCRAEXT.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    $page->setFont($font, 12);
    $page->setFont($page->getFont(), 12);
    alignedText(array('y'=>'346','xStart'=>'100','xEnd'=>'','align'=>'left'),utf8_decode("$account"),$page,$offsety);    $page->setFont($page->getFont(), 12);
    alignedText(array('y'=>'346','xStart'=>'270','xEnd'=>'300','align'=>'left'),utf8_decode("$givTot"),$page,$offsety);    $page->setFont($page->getFont(), 12);
    alignedText(array('y'=>'346','xStart'=>'330','xEnd'=>'','align'=>'left'),utf8_decode("$checkSum"),$page,$offsety);    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    $page->setFont($font, 10);
    ...
    alignedText(array('y'=>'245','xStart'=>'45','xEnd'=>'600','align'=>'left'),utf8_decode("$giverText"),$page,$offsety);    $t = array('y'=>177,'align'=>'left','xStart'=>300,'xEnd'=>'');
    alignedText($t,dbTexts('FullName,CoAddress,Address,Post',$row,'EOL'),$page,$offsety);
    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/OCRAEXT.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    $page->setFont($font, 12);
    $page->setFont($page->getFont(), 12);
    alignedText(array('y'=>'66','xStart'=>'100','xEnd'=>'','align'=>'left'),utf8_decode("$account"),$page,$offsety);    $page->setFont($page->getFont(), 12);
    alignedText(array('y'=>'66','xStart'=>'270','xEnd'=>'300','align'=>'left'),utf8_decode("$givTot"),$page,$offsety);    $page->setFont($page->getFont(), 12);
    alignedText(array('y'=>'66','xStart'=>'330','xEnd'=>'','align'=>'left'),utf8_decode("$checkSum"),$page,$offsety);    }
    //end of giver loop.
}
...
//output pdf inline
$dfile = "Inbetalningskort (test)$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Inbetalningskort (test).pdf";
}
