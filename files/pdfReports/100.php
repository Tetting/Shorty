...
<tr><th colspan="2">Specialbrev</th></tr>
<tr><td colspan="2">Skriver ut specialbrev.</td></tr><tr><td>Givare#:</td><td><input name="id" value="<?
...
while($row) {    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    ...
    $t = array('y'=>553,'align'=>'left','xStart'=>141,'xEnd'=>'530');
    alignedText($t,dbTexts('',$row,' '),$page,$offsety);
...
//output pdf inline
$dfile = "Specialbrev$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Specialbrev.pdf";
}
