...
<tr><th colspan="2">Inbetalningar per givare</th></tr>
<tr><td colspan="2">Skapar lista med inbetalningar för givare.</td></tr><tr><td>Givar#:</td><td><input name="id" value="<?
...
Order by Payment.Date Asc";
    ...
    //add a totals row...
    $row = array();
    $row["Payment.InKrTotal"] = "<b>".$tot."</b>";$row["Project.Project"] = "<b>Totalt</b>";
    $data[] = $row;
