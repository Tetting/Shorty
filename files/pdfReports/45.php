...
<tr><td>Projekt#:</td><td><input name="id" value="<?
...
Where
Payment.ProjectId = $id and InkrTotal > 0
and (Payment.Date between '2013-01-01' and '2013-03-31')

Order by Payment.InKrTotal ASC";
    ...
    $pdf->ezTable(
	    ...
	    ,array('Giver.Id'=>'Givar#'  
                ,'Giver.FullName'=>'Namn'  
                ,'Payment.InKrTotal'=>'InKr'  
                
        )
	    ,html_entity_decode("<b>Projekt $id</b>")
        //options
