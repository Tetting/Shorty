...
<tr><td colspan="2">Skriver ut hyresbekräftelse<br />till ägare.</td></tr><tr><td>Husvagns#:</td><td><input name="id" value="<?
...
while($row) {    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arial.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    ...
    $font = Zend_Pdf_Font::fontWithPath($reportPath.'/fonts/arialbd.ttf',Zend_Pdf_Font::EMBED_SUPPRESS_EMBED_EXCEPTION); 
    $page->setFont($font, 12);
    $t = array('y'=>111,'align'=>'left','xStart'=>57,'xEnd'=>'530');
...
//output pdf inline
$dfile = "Husvagn - hyresbekräftelse ägare$id.pdf";
if (strpos($id,',')>0) {
    $dfile = "Husvagn - hyresbekräftelse ägare.pdf";
}
